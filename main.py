...
def main():
    ...
    num_classes = 100
    train_ds, test_ds = data_set.get_data(num_classes)
    kwargs = {"optimizer": optimizer, "num_classes": num_classes, "train_ds": train_ds, "test_ds": test_ds}

    # parse arguments for experiment type
    parser = argparse.ArgumentParser()
    parser.add_argument("--experiment_type", type=str, default="control", help="Type of experiment to run")

    #Hypothetical
    if parser.parse_args().experiment_type == "hypothetical":
    ...
    #Control
    elif parser.parse_args().experiment_type == "control":
        for model_name, model_func, input_shape in models:
            ...
            eval.eval_model(test_ds=test_ds, params=params,experiment_type=experiment_type)
    #Experiment 1
    elif parser.parse_args().experiment_type == "experiment_1":
        for model_name, model_func, input_shape in models:
            ...
            eval.eval_model(test_ds=test_ds, params=params,experiment_type=experiment_type)
    #Experiment 2
    elif parser.parse_args().experiment_type == "experiment_2":
        for model_name, model_func, input_shape in models:
            ...
            eval.eval_model(test_ds=test_ds, params=params,experiment_type=experiment_type)
    #Experiment 3
    elif parser.parse_args().experiment_type == "experiment_3":
        for model_name, model_func, input_shape in models:
